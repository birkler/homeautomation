...
class JuraCoffee : public PollingComponent, public UARTDevice {
 ...
 public:
  ...
  void update() override {
    ...
    // For Testing
    int read_bit0 = bitRead(hex_to_byte, 0);
    int read_bit1 = bitRead(hex_to_byte, 1);
    int read_bit2 = bitRead(hex_to_byte, 2);
    int read_bit3 = bitRead(hex_to_byte, 3);
    int read_bit4 = bitRead(hex_to_byte, 4);
    int read_bit5 = bitRead(hex_to_byte, 5);
    int read_bit6 = bitRead(hex_to_byte, 6);
    int read_bit7 = bitRead(hex_to_byte, 7);
